...
(async (input) => {
  ...
  // Проверяем каждую работу на соответствие искомым параметрам
      for (let i = 0; i < countItems; i++) {
          ...
          let percent = Number(item[5].firstElementChild.firstElementChild.getAttribute("style").split('%')[0].split(':')[1]);
  ...
  // В случае, если соответствий нет, выводим -1
    ...
    //   Выбираем нужную работу в нагрузке
    if (itemIndex == -1) {
      await browser.close();
      return null;
    }
...
// Закрываем браузер
  ...
  {name: "Математика", groups: "ТиТб-1801-01-24", cat: 0, kab: "11-30", date: "01.09.2022", time: 1, count: 2},
  {name: "Математика", groups: "ТиТб-1801-01-24", cat: 0, kab: "14-130", date: "02.09.2022", time: 2, count: 2},
  {name: "Математика", groups: "ТиТб-1801-01-24", cat: 0, kab: "14-140", date: "03.09.2022", time: 3, count: 2},
  {name: "Математика", groups: "ТиТб-1801-01-24", cat: 0, kab: "14-235", date: "04.09.2022", time: 4, count: 2},
  {name: "Математика", groups: "ТиТб-1801-01-24", cat: 0, kab: "16-400", date: "05.09.2022", time: 5, count: 2},
]);